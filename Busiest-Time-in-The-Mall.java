...
data =         [ [1487799425, 14, 1], // +14 14

                 [1487799425, 4,  0], // -4  10
                 [1487799425, 2,  0], // -2   8 -- 1487799425   8
                 [1487800378, 10, 1], // +10 18 -- 1487800378   18
                 [1487801478, 18, 0], // -18  0
                 [1487801478, 18, 1], // +18 18 -- 1487801478   18
                 [1487901013, 1,  0], // -1  17 -- 1487901013   17
                 [1487901211, 7,  1], // +7  24
                 [1487901211, 7,  0] ] // -7 17 -- 1487901211   17
output: 1487800378
                 
         // Time Complexity = O(n) Space Complexity(worst) = O(n)
         1. initialize count = a[0][1];  14
         2. Iterate over the array
            a. Check if a[i][2] == 0
                count - a[i][1]
                else
                 count + a[i][1]
            b. store in a map(a[i][0], count)
             or keep checking for max element

         3. get Max out of map elements
